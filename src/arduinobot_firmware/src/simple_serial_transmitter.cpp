...
public:
	...
	{
		declare_parameter<std::string>("port","virtualcom0");
	...
	{
		RCLCPP_INFO_STREAM(get_logger(), "New msg received, publishing on serial port: " << msg.data);
