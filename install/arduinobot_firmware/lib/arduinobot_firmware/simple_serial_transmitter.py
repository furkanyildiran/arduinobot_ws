...
class SimpleSerialTransmitter(Node):
	def __init__(self):
		...
		self.decleare_parameter("port", "/dev/virtualcom0")
		self.decleare_parameter("baud_rate", 115200)
	...
	def msgCallback(self, msg):
		self.get_logger().info("New msg received, publishing on serial: %s" % self.arduino_.name)
